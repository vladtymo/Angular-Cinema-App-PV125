...
export const MOVIES: IMovie[] = [
    { 
        id: 1, title: "Wrath of Man", 
        genres: 
        [
            { id: 1, name: "Action"}, 
            { id: 2, name: "Crime" }
        ], 
        year: 2021, duration: "1:58", 
        coverUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_ydyAFZAMYSBM2JzptcwDomPl_ZsO35KsxkX2YqXT_BeiienwWjEv8gLJRncsVJTZSb8&usqp=CAU" },
